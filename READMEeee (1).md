...
The Gradio interface is embedded directly in the notebook — simply run all cells and the app launches automatically in your browser.
...
```bash
pip install pandas numpy matplotlib seaborn scikit-learn gradio jupyter
```
...
Once open, run all cells. The **Gradio interface** launches automatically at the bottom — opening in your browser or generating a public shareable link.
